...
object RetrofitClient {
    ...
    private val metronClient: OkHttpClient = OkHttpClient.Builder()
        .addInterceptor(Interceptor { chain ->
            val request = chain.request().newBuilder()
                .header("Authorization", "Bearer fa983adb4227b326ebb5eef1b847875f345b27ce2d7bcc91e5068e17d3e6b255")
                .build()
            chain.proceed(request)
        })
        .build()

    private val metronRetrofit: Retrofit = Retrofit.Builder()
        .baseUrl(METRON_BASE_URL)
        .client(metronClient)
    ...
    private val translationRetrofit: Retrofit = Retrofit.Builder()
